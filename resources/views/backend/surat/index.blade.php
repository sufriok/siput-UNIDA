                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="center">
                                    <form action="{{ route('surat.destroy', $delivery) }}" method="post">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
                                    <button type="button" class="btn btn-info"><a href="{{ route('surat.edit', $delivery) }}"><i class="fa fa-edit fa-fw"></i></a></button>
